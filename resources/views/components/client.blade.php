<div class='container-fluid item py-4 mb-1'> 
                <div class='row mb-2'> 
                <div class='col-12'> 
                    <a href='/account/{{$id}}'><h3></h3></a> 
                </div> 
                <div class='col-12'> 
                    <p>ID Cliente: <span class='semibold'><span>{{$id}}</p> 
                </div> 
                <div class='col-12'> 
                    <p>Razon social: <span class='semibold'>{{$businessName}}</span></p> 
                </div> 
                <div class='col-12'> 
